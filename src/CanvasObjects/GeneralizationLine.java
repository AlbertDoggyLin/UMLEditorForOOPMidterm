...
public class GeneralizationLine extends ConnectionCanvasObj{
    public GeneralizationLine(Canvas canvas) {
        super(canvas);
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        Point intersectionPoint = new Point(
                (int)(arrowlength*cos45*refx+endPoint.x),
                (int)(arrowlength*cos45*refy+endPoint.y)
        );
        ...
        g.drawLine(endPoint.x+(int)x45, endPoint.y+(int)y45, endPoint.x+(int)y45, endPoint.y+(int)ym45);
    }
}
